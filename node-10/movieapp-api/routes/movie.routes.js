...
//GET A Movies : localhost:3000/api/movies/top10
...
// // router.get('/', (req, res) => {
// //   res.send('GET request to the Movie List')
// // })
...
// // 603c038355a5778979185256
// //GET A Movie : localhost:3000/api/movies/:movieId
// router.get('/:movieId', (req, res) => {
//   MovieModel.findById(req.params.movieId)
//                   .then((movie)=>{res.json(movie)})
//                   .catch((errMsg)=>{res.json(errMsg)})
...
// //GET Between Movies : localhost:3000/api/movies/between/:startYear/:endYear
// router.get('/between/:startYear/:endYear', (req, res) => {
//   const {startYear,endYear} = req.params;
//   //Greater Than or Equal & Less Than or Equal
//   MovieModel.find({year:{"$gte":parseInt(startYear),"$lte":parseInt(endYear)}})
